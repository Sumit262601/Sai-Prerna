...
<body>
            ...
            <div class="container-fluid">
				...
				<section id="main-content">
                                            ...
                                            <table class="table f-s-11 table-striped">
                                                ...
                                                <tbody>
                                                   <tr>
                                                        ...
                                                        <td></td>
                                                        <td><h6></h6></td>
                                                        <td><a class="badge badge-success" href=""><i class="ti ti-eye"></i></a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="footer">
                                <p>This dashboard was generated on <span id="date-time"></span> <a href="#" class="page-refresh"> Dil karee to Refresh kar sakte h Dashboard</a></p>
                            </div>
                        </div>
                    </div>
                </section>
    ...
    <script src="<?= site_url('assets/'); ?>/js/lib/jquery.min.js"></script>
    <!-- jquery vendor -->
    <script src="<?= site_url('assets/'); ?>/js/lib/jquery.nanoscroller.min.js"></script>
    <!-- nano scroller -->
    <script src="<?= site_url('assets/'); ?>/js/lib/menubar/sidebar.js"></script>
    <script src="<?= site_url('assets/'); ?>/js/lib/preloader/pace.min.js"></script>
    <!-- sidebar -->
    <script src="<?= site_url('assets/'); ?>/js/lib/bootstrap.min.js"></script>
