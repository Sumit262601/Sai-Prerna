                ...
                <section id="main-content">
                    <div class="card">
                        <div class="card-header m-b-20">
                            <div class="row">
								<form action="<?=site_url('web-admin/slide');?>" method="post">
									<div class="col-md-4">
                            ...
                            <table class="table f-s-13">
                                ...
                                <tbody>
                                    <?php foreach($slides as $sld){?>
									    <tr>
                                            <td><img src="<?=site_url();?>images/<?= $images[$sld->img]->location; ?>" width="300px"></td>
                                            <td><?= $sld->alt; ?></td>
                                            <td><?= $sld->last_update; ?></td>
                                            <td><?= $user_info[$sld->update_by]->f_name; ?></td>
                                            <td id="slide-<?=$sld->id?>"><?= ($sld->status == 'D')?'
									    		<a href="#" data-src="'.site_url('/web-admin/slide/change-status-slide').'"    
                                            ...
                                            <td>
									    		<a class="edit-slide badge badge-primary" href="#" data-toggle="modal" data-target="#editSlide" 
									    			data-imgid="<?=$sld->img?>" 
									    			data-alt="<?= $sld->alt; ?>" 
			...
			<div class="modal-body">
				...
				<div class="tab-content">
					<div id="uploadadd" class="tab-pane fade">
						<form class="form-submit" style="margin:40px 0;" action="<?= site_url('/web-admin/slide/upload_slide_img')?>" method="post" enctype="multipart/form-data">
							<input type="file" name="slide_images" multiple>
					...
					<div id="mediaadd" class="tab-pane fade in active">
						<div class="row">
							...
							<div class="col-sm-6 attach-details">
								<form class="form-submit" method="post" action="<?= site_url('/web-admin/slide/add_slide')?>">
									<div class="row">
										<div class="col-md-12">
											<h6>slide Details</h6>
									...
									<div class="row">
										<div class="col-md-6 col-sm-12 form-group">
											...
											<input id="csrf-token" type="hidden" name="<?= csrf_token(); ?>" value="<?= csrf_hash(); ?>">
											<button type="submit" class="btn btn-success" style="width: 100%;"> <span class="btn-val">Add Slides</span></button>
										</div>
										<div class="col-md-6 col-sm-12 form-group">
										<input id="csrf-token" type="hidden" name="<?= csrf_token(); ?>" value="<?= csrf_hash(); ?>">
...
<div class="modal fade" id="editSlide" role="dialog">
	<div class="modal-dialog modal-lg modal-full">
		<!-- Modal content-->
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="tab-content">
					...
					<div id="edtmediaadd" class="tab-pane fade in active">
						<div class="row">
							...
							<div class="col-sm-6 attach-details">
								<form class="form-submit" method="post" action="<?= site_url('/web-admin/slide/update_slide')?>">
									<div class="row">
										<div class="col-md-12">
											<h6>slide Details</h6>
									...
									<div class="row">
										<div class="col-md-6 col-sm-12 form-group">
											...
											<input type="hidden" class="form-control" name="slide_id">
											<input id="csrf-token" type="hidden" name="<?= csrf_token(); ?>" value="<?= csrf_hash(); ?>">
											<button type="submit" class="btn btn-success" style="width: 100%;"> <span class="btn-val">Update Slides</span></button>
										</div>
										<div class="col-md-6 col-sm-12 form-group">
										<input id="csrf-token" type="hidden" name="<?= csrf_token(); ?>" value="<?= csrf_hash(); ?>">
											<button type="button" class="btn btn-danger" style="width: 100%;"> <span class="btn-val">Delete Image</span></button>
    ...
    <script>
        $( function() {
			...
			$('.edit-slide').on('click',function(){
				...
				$('input[name=slide_id]').attr('value',slideid);
